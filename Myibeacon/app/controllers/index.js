...
function startBeacon() {
	...
	TiBeacons.addEventListener("beaconProximity", function(e) {
		...
		// $.webView.url = "http://www.nba.com";
		// else if (purple > orange && purple > yellow)
		// $.webView.url = "https://punchthrough.com/bean";
		// else if (yellow > orange && yellow > purple)
		// $.webView.url = "http://www.tvb.com";
...
var heartRateData = ['78', '76', '72', '78', '76', '72', '78', '76', '72'];
...
function characteristicValue(e) {
	...
	if (e.characteristic.uuid == "2a37") {
		...
		heartRateData.push(parseInt(e.characteristic.value, 16));
		heartRateData.shift();
